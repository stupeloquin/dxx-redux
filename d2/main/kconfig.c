...
#ifdef __ANDROID__
/* Gamepad defaults assuming standard layout: 11 buttons, 1 hat, 6 axes.
 * RT=fire, RB=fire2, LT=slide down, LB=slide up, X=bank left, A=bank right,
 * Y=cycle primary, B=cycle secondary. Triggers are axis buttons 25(RT)/23(LT). */
{0x19,0x05,0xff,0xff,0xff,0xff,0xff,0xff,0x04,0x17,0xff,0x02,0x00,0x1,0x0,0x0,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0xff,0x03,0x01,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x0,0x0,0x0,0x0},
#else
